import pandas as pd
from ImageGenerator_new import ImageGenerator, TextToImageGenerator  # Ensure this is imported from your ImageGenerator module
...
process_prompts(0, 100, mode="text2img")  # Change to `mode="text2img"` to test text-to-image generation
